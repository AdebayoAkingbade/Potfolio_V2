...
Senior software engineer with experience building fintech onboarding, digital banking admin,
education, commerce, Web3, and AI-powered systems. Strong across React, Next.js, Angular,
Java Spring Boot, NestJS, Python NLP, RBAC, SSO, audit workflows, and scalable product delivery.

## Experience

### Software Engineer (Contract), Ecobank Transnational Incorporated
...
### Software Engineer (Contract), Belrald

2024

- Designed backend services using NestJS, including scalable APIs and authentication systems.
- Built institution and staff onboarding, password creation, password reset, and account recovery workflows.
- Designed dynamic RBAC systems for flexible role creation and permission mapping.

### Lead Frontend Engineer, Conclase

2021 - 2023

- Led enterprise Next.js and React application development.
- Mentored junior engineers through architecture, implementation, and delivery reviews.
- Built dashboards that improved onboarding and internal workflows.
...
React, Next.js, Angular, TypeScript, Java, Spring Boot, NestJS, Node.js, Python, NLP, RBAC,
SSO, GraphQL, Docker, Firebase, Vercel, PostgreSQL, Redis, CI/CD, authentication,
authorization, audit workflows, maker-checker systems, frontend architecture.
